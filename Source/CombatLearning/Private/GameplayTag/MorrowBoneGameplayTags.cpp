...
namespace MorrowBoneGameplayTags
{
	...
	UE_DEFINE_GAMEPLAY_TAG(
		Player_SetByCaller_AttackTypes_LightAttack,
		TEXT("Player.SetByCaller.AttackTypes.LightAttack"))
	UE_DEFINE_GAMEPLAY_TAG(
		Player_SetByCaller_AttackTypes_HeavyAttack,
		TEXT("Player.SetByCaller.AttackTypes.HeavyAttack"))
	...
	UE_DEFINE_GAMEPLAY_TAG(
		Player_Cooldown_SpecialWeaponAbility_Light,
		TEXT("Player.Cooldown.SpecialWeaponAbility.Light"))
	UE_DEFINE_GAMEPLAY_TAG(
		Player_Cooldown_SpecialWeaponAbility_Heavy,
		TEXT("Player.Cooldown.SpecialWeaponAbility.Heavy"))
