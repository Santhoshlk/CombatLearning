...
void AMorrowBone::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerComponent->BindingInputs(
		InputConfig,
		MorrowBoneGameplayTags::InputTag_Look,
		ETriggerEvent::Triggered,
		this,
		&AMorrowBone::Looking);
	PlayerComponent->BindingInputs(
		InputConfig,
		MorrowBoneGameplayTags::InputTag_Move,
		ETriggerEvent::Triggered,
		this,
		&AMorrowBone::Moving);
	PlayerComponent->BindingInputs(
		InputConfig,
		MorrowBoneGameplayTags::InputTag_SwitchTargets,
		ETriggerEvent::Triggered,
		this,
		&ThisClass::SwitchTargetsTriggered);
	PlayerComponent->BindingInputs(
		InputConfig,
		MorrowBoneGameplayTags::InputTag_SwitchTargets,
		ETriggerEvent::Completed,
		this,
		&ThisClass::SwitchTargetsCompleted);
	PlayerComponent->BindAbilityInputAction(
		InputConfig,
		this,
		&AMorrowBone::AbilityInputAction_Pressed,
		&AMorrowBone::AbilityInputAction_Released);
}
...
void AMorrowBone::SwitchTargetsCompleted(const FInputActionValue& value)
{
	...
	UAbilitySystemBlueprintLibrary::SendGameplayEventToActor(
		this,
		SwitchInput.X > 0.f
			? MorrowBoneGameplayTags::Player_Event_SwitchTarget_Right
			: MorrowBoneGameplayTags::Player_Event_SwitchTarget_Left,
		Data
	);
}
